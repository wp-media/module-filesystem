...
if ( ! function_exists( 'rocket_has_i18n' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_i18n_code' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_i18n_host' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_i18n_uri' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_i18n_to_preserve' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_i18n_subdomains' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_i18n_translated_post_urls' ) ) {
	/**
...
if ( ! function_exists( 'rocket_get_home_url' ) ) {
	/**
...
if ( ! function_exists( 'rocket_get_current_language' ) ) {
	/**
