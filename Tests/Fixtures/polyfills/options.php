...
if ( ! function_exists( 'rocket_is_plugin_active_for_network' ) ) {
	/**
...
if ( ! function_exists( 'is_rocket_generate_caching_mobile_files' ) ) {
	/**
...
if ( ! function_exists( 'rocket_get_ignored_parameters' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_cache_reject_uri' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_cache_reject_cookies' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_cache_mandatory_cookies' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_cache_dynamic_cookies' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_cache_reject_ua' ) ) {
	/**
...
if ( ! function_exists( 'get_rocket_cache_query_string' ) ) {
	/**
...
if ( ! function_exists( 'rocket_delete_licence_data_file' ) ) {
	/**
...
if ( ! function_exists( 'rocket_is_subfolder_install' ) ) {
	/**
...
if ( ! function_exists( 'rocket_get_home_dirname' ) ) {
	/**
...
if ( ! function_exists( 'rocket_get_main_home_url' ) ) {
	/**
